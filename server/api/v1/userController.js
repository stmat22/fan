...
class UserController {
  ...
  static create(req, res, next) {
    ...
    .catch(err => validationError(parseJoiError(err)));
  }
  ...
  static updateProfile(req, res, next) {
    ...
    _.merge(req.user, _.pick(req.body.user, [
      'username','name', 'email', 'phone', 'photo', 'age', 'firstName', 'lastName',
      'bust', 'description', 'ethnicity', 'eyes', 'hair',
      'height', 'hometown', 'languages', 'publicHair', 'sexualPreference',
      'sex', 'weight', 'subscriptionMonthlyPrice', 'bankAddress2',
      ...
      'bankAccount', 'bankRounding', 'bankSwiftCode', 'bankBankAddress', 'welcomePhoto', 'welcomeVideo', 'welcomeOption',
       'showHome', 'ccbill', 'allowIds', 'autoPostTwitter', 'customTwitterTextVideo', 'skrill'
    ]));
