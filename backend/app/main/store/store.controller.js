angular.module('xMember').controller('StoreCtrl', function ($scope, $state, growl, productService, products, productCount) {
  ...
  $scope.pageChanged = function (currentPage) {
    productService.findAll('undefined', 'undefined', $scope.query).then(function (res) {
...
angular.module('xMember').controller('StoreEditCtrl', function ($scope, $sce, $state, productService, perfomerService, growl, product, Upload, $timeout, categories) {
  $scope.action = 'Edit';
...
angular.module('xMember').controller('StoreAddCtrl', function ($scope, $sce, $state, productService, perfomerService, growl, Upload, $timeout, categories) {
  $scope.action = 'Add';
  $scope.product = {
    name: '',
    imageThumbPath: null,
