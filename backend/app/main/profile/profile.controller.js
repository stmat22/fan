...
angular.module('xMember').controller('FavoriteCtrl', function ($scope, $timeout, $state, Auth, growl, userService) {
  ...
  $scope.favorites = Auth.getCurrentUser().favoriteVideo;
  $scope.limit = 6;
  $scope.pager = {};  
  ...
  $scope.remove = function(index){
    ...
    userService.removeFavoriteVideo(Auth.getCurrentUser()).then(function(res){
...
angular.module('xMember').controller('WatchLaterCtrl', function ($scope, $timeout, $state, Auth, growl, userService ) {
  ...
  $scope.videos = Auth.getCurrentUser().watchLaterVideo;
  ...
  $scope.remove = function(index){
    ...
    userService.removeWatchLaterVideo(Auth.getCurrentUser()).then(function(res){
...
angular.module('xMember').controller('DownloadedCtrl', function ($scope, $rootScope, $timeout, $state, Auth, growl) {
  ...
  $scope.downloaded = Auth.getCurrentUser().downloadedVideo;
