...
angular.module('xMember').controller('SignupUserCtrl', function($scope, $rootScope, $state, userService, growl, Auth, User, $stateParams, $cookies, Upload){
...
angular.module('xMember').controller('SignupSuccessCtrl', function($scope, $state, Auth, $stateParams){

  return false;
});


angular.module('xMember').controller('ForgotCtrl', function($scope, $state, Auth, userService){
  ...
  angular.module('xMember').controller('SignupChooseCtrl', function($scope, $state, Auth, userService){
    Auth.getCurrentUser(function(user) {
      if(user.role === 'performer'){
        document.location = '/'+user.username;
      }
