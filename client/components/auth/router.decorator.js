  ...
  angular.module('xMember.auth')
    .run(function($rootScope, $state, $cookies, Auth) {
      ...
      $rootScope.$on('$stateChangeStart', function(event, next) {
        let allowUnauthenticatedStates = ['login', 'signup', 'pageView', 'logout', 'signupPerformer',
         'paymentSuccess', 'contact', 'forgot', 'landing', 'modelView', 'signupMember', 'escorts', 'help', 'aboutUs', 'paymentThanks', 'paymentCancel'];
